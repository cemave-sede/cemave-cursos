...
valueBox(dim(cursos)[1], icon = "fa-binoculars", color = "#458B41")
```
...
#     select(- ID) %>% 
#     select(ano, participantes, curso, categoria, instituicao, tipos.inst, local, municipio, UF, regiao, pais)
# 
# lista_cursos <- datatable(tab_participantes2,
#           caption = 'Tabela 2. Lista de participantes nos cursos ministrados pelo CEMAVE de 1978 a 2022.',
# 
#           colnames = c('Ano', 'Curso', 'Participante', 'Condição', 'Instituição', 'Tipo de Instituição', 'Local', 'Município', 'UF', 'Região', 'País'),
# 
#           extensions = 'Buttons',
#                            elementId = NULL,
#                            #extensions= "Scroller",
